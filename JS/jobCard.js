class JobCard{
    constructor( {
        ...
        this.jobCard.classList.add("job-card");
        if(featuredOrNot === true){this.jobCard.classList.add("job-card--featured");}
        this.jobCard.innerHTML = `
        ...
        <div class="job-card__keywords">
            <div class="job-card__keywords-item">${role}</div>
            <div class="job-card__keywords-item">${level}</div>
        </div>
        `;

        [...languages,...tools].forEach(element => {
            let tempNode = document.createElement('div') ;
            tempNode.classList.add('job-card__keywords-item') ;
            tempNode.innerText = element;
            this.jobCard.getElementsByClassName('job-card__keywords')[0].append(tempNode);
        }) 
    }
}
